...
export default function MetaButton({ content, marginTop = '0px', marginLeft = '0px', marginRight = '0px', marginBottom = '0px', margin, background = 'white', icon = "", callback }) {
    return (
        <div onClick={() => callback ? callback() : () => {}}>
            <MetaButtonStyle marginTop={marginTop} marginLeft={marginLeft} marginRight={marginRight} marginBottom={marginBottom} >
                ...
                <div style={{ position: "absolute", zIndex: '-1' }}>
                    <MetaButtonBody width="103" height="56" viewBox="0 0 103 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 32.6514V1H38.5V57H21L1 32.6514Z" fill="#FF1C6E" fillOpacity="0.3" />
                        <path d="M102 25.3486V57H64V1H82L102 25.3486Z" fill="#FF1C6E" fillOpacity="0.3" />
                        <path d="M38.5 25.3486V57H64V1H38.5V25.3486Z" fill="#FF1C6E" fillOpacity="0.3" />
                        <path d="M49.5 1L1 1V36.1297L21 57H49.5" stroke="#FF1C6E" strokeWidth="2" />
                        <path d="M53.5 57L102 57V21.8703L82 1H53.5" stroke="#FF1C6E" strokeWidth="2" />
                        <path d="M56.5 57L43 57" stroke="#FF1C6E" strokeWidth="2" />
                        <path d="M56.5 1H43" stroke="#FF1C6E" strokeWidth="2" />
                    </MetaButtonBody>
                ...
                <MetaButtonCornerLeftUp width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.6892 0L0 12.6892V0H12.6892Z" fill="#FF1C6E" />
                </MetaButtonCornerLeftUp>

                <MetaButtonCornerLeftDown width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M-6.55671e-07 1.90735e-06L15 15L0 15L-6.55671e-07 1.90735e-06Z" fill="#FF1C6E" />
                </MetaButtonCornerLeftDown>

                <MetaButtonCornerRightUp width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 0L15 15V0H0Z" fill="#FF1C6E" />
                </MetaButtonCornerRightUp>

                <MetaButtonCornerRightDown width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13 0.310772L0.310772 13L13 13L13 0.310772Z" fill="#FF1C6E" />
